...
class Linear(nn.modules.linear.Linear, TorchModule):
    def __init__(
        self, in_features, out_features, bias=True, device=None, dtype=None, **kwargs
    ):
        TorchModule.__init__(self)
        self.param_dict["bias"] = bias
        self.param_dict["device"] = device
...
class NonDynamicallyQuantizableLinear(
    nn.modules.linear.NonDynamicallyQuantizableLinear, TorchModule
):
    def __init__(
        self, in_features, out_features, bias=True, device=None, dtype=None, **kwargs
    ):
...
class GRUCell(nn.modules.rnn.GRUCell, TorchModule):
    def __init__(
        self, input_size, hidden_size, bias=True, device=None, dtype=None, **kwargs
    ):
        TorchModule.__init__(self)
        self.param_dict["bias"] = bias
        self.param_dict["device"] = device
...
class TransformerDecoderLayer(
    nn.modules.transformer.TransformerDecoderLayer, TorchModule
):
    def __init__(
        self,
        d_model,
...
class TransformerEncoderLayer(
    nn.modules.transformer.TransformerEncoderLayer, TorchModule
):
    def __init__(
        self,
        d_model,
...
class BCELoss(nn.modules.loss.BCELoss, TorchModule):
    def __init__(
        self, weight=None, size_average=None, reduce=None, reduction="mean", **kwargs
    ):
        TorchModule.__init__(self)
...
class CosineEmbeddingLoss(nn.modules.loss.CosineEmbeddingLoss, TorchModule):
    def __init__(
        self, margin=0.0, size_average=None, reduce=None, reduction="mean", **kwargs
    ):
        TorchModule.__init__(self)
...
class HingeEmbeddingLoss(nn.modules.loss.HingeEmbeddingLoss, TorchModule):
    def __init__(
        self, margin=1.0, size_average=None, reduce=None, reduction="mean", **kwargs
    ):
        TorchModule.__init__(self)
        self.param_dict["margin"] = margin
        self.param_dict["size_average"] = size_average
...
class SmoothL1Loss(nn.modules.loss.SmoothL1Loss, TorchModule):
    def __init__(
        self, size_average=None, reduce=None, reduction="mean", beta=1.0, **kwargs
    ):
        TorchModule.__init__(self)
        self.param_dict["size_average"] = size_average
        self.param_dict["reduce"] = reduce
...
class TripletMarginWithDistanceLoss(
    nn.modules.loss.TripletMarginWithDistanceLoss, TorchModule
):
    def __init__(self, **kwargs):
        TorchModule.__init__(self)
        self.param_dict.update(kwargs)
