...
TASK_VERSION = click.option("--task-version", type=click.STRING, help=TASK_VERSION_DESC)
...
NAME = click.option("--name", type=click.STRING, help=NAME_DESC)
NAME_REQUIRED = click.option("--name", type=click.STRING, help=NAME_DESC, required=True)
NAMESPACE = click.option("--namespace", type=click.STRING, help=NAMESPACE_DESC)
NAMESPACE_REQUIRED = click.option("--namespace", type=click.STRING, required=True, help=NAMESPACE_DESC)
DISPLAY = click.option("--display", type=click.STRING, required=False, help=DISPLAY_DESC)
MODEL_ID = click.option("--model-id", type=click.STRING, help=MODEL_ID_DESC)
MODEL_ID_REQUIRED = click.option("--model-id", type=click.STRING, required=True, help=MODEL_ID_DESC)
MODEL_VERSION = click.option("--model-version", type=click.STRING, help=MODEL_VERSION_DESC)
MODEL_VERSION_REQUIRED = click.option("--model-version", type=click.STRING, required=True, help=MODEL_VERSION_DESC)
...
TIMEOUT = click.option("--timeout", type=click.INT, default=300, help=TIMEOUT_DESC)
